# D2.2F Stronger Reflection Directive Report

Planning commit: `5e6b06907b5c591728af711f3378117838210874`
Run root: `shard_workspace/d2_2f_runs/20260506_180229`
...
Does a stronger but still non-overriding reflection directive produce clearer decision-adjacent retry behavior in ARM_ON?

## Micro-Fix Applied

- Target gate: `reflection_trigger` / retry reflection prompt path.
- Modified path: `backend/study_phases.py::_retry_gap_fill`.
- Change: the D2.2D reflection directive was strengthened, but remains a prompt modifier and not an override.
- Stronger directive: explicitly identify the prior failed strategy, explain why it failed, and produce a materially different recovery plan.

Behavior/scoring guardrails:
- `MAX_RETRY` unchanged.
- Certification threshold unchanged.
- Scoring logic unchanged.
- `_WINNER_BIAS` unchanged in D2.2F.
...
- D2.2F stronger reflection directive only, not D2.2 full.
...
| sequence | rep | arm | recovery_success | retries_count | certification_verdict | final_score | repeated_strategy_count | loop_risk_proxy | retry_hash_available | retry_strategy_hash_changed | material_strategy_shift | repeated_strategy_count_by_hash | micro_coupling_applied | reflection_directive_present | stronger_directive_present |
|---|---:|---|---|---:|---|---:|---:|---:|---|---|---|---:|---|---|---|
| `seq_01_oop_to_asyncio` | 1 | `ARM_OFF` | `False` | `2` | `FAILED` | `3.75` | `1` | `4` | `True` | `True` | `True` | `0` | `False` | `False` | `False` |
| `seq_01_oop_to_asyncio` | 1 | `ARM_ON` | `False` | `2` | `FAILED` | `3.25` | `1` | `4` | `True` | `True` | `True` | `0` | `True` | `True` | `True` |
| `seq_01_oop_to_asyncio` | 2 | `ARM_OFF` | `False` | `2` | `FAILED` | `3.5` | `1` | `4` | `True` | `True` | `True` | `0` | `False` | `False` | `False` |
| `seq_01_oop_to_asyncio` | 2 | `ARM_ON` | `False` | `2` | `FAILED` | `3.5` | `1` | `4` | `True` | `True` | `True` | `0` | `True` | `True` | `True` |
| `seq_02_sql_to_error_handling` | 1 | `ARM_OFF` | `False` | `2` | `FAILED` | `3.75` | `1` | `4` | `True` | `True` | `True` | `0` | `False` | `False` | `False` |
| `seq_02_sql_to_error_handling` | 1 | `ARM_ON` | `False` | `2` | `FAILED` | `3.75` | `1` | `4` | `True` | `True` | `True` | `0` | `True` | `True` | `True` |
| `seq_02_sql_to_error_handling` | 2 | `ARM_OFF` | `False` | `2` | `FAILED` | `3.75` | `1` | `4` | `True` | `True` | `True` | `0` | `False` | `False` | `False` |
| `seq_02_sql_to_error_handling` | 2 | `ARM_ON` | `False` | `2` | `FAILED` | `3.5` | `1` | `4` | `True` | `True` | `True` | `0` | `True` | `True` | `True` |
...
|---|---:|---|---|---|---|---|---:|---|
| `seq_01_oop_to_asyncio` | 1 | `ARM_OFF` | `log_focus_gap_proxy_sha256_12` | `['2ba75396e901', '6c856009185d']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
| `seq_01_oop_to_asyncio` | 1 | `ARM_ON` | `log_focus_gap_proxy_sha256_12` | `['6063e5e9bf0b', 'e4b6544445b1']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
| `seq_01_oop_to_asyncio` | 2 | `ARM_OFF` | `log_focus_gap_proxy_sha256_12` | `['f700d83f3767', 'c7bd6cafb9cc']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
| `seq_01_oop_to_asyncio` | 2 | `ARM_ON` | `log_focus_gap_proxy_sha256_12` | `['8e01e30623fc', '524fb4009934']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
| `seq_02_sql_to_error_handling` | 1 | `ARM_OFF` | `log_focus_gap_proxy_sha256_12` | `['847d1cb2bc83', 'b068f8df5837']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
| `seq_02_sql_to_error_handling` | 1 | `ARM_ON` | `log_focus_gap_proxy_sha256_12` | `['3b596f32ed80', '78db3fc52095']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
| `seq_02_sql_to_error_handling` | 2 | `ARM_OFF` | `log_focus_gap_proxy_sha256_12` | `['133a2c7a4ce2', '1b1529dfee36']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
| `seq_02_sql_to_error_handling` | 2 | `ARM_ON` | `log_focus_gap_proxy_sha256_12` | `['3900ade9f714', 'cb005d500359']` | `True` | `True` | `0` | `hashes are derived from retry Focus/gaps log lines, not full semantic retry plans; hash changes indicate proxy text changes, not guaranteed semantic strategy shifts; prior_strategy_named is unavailable because full retry prompt text is not logged` |
...
| `seq_01_oop_to_asyncio` | `ARM_ON` | `3.375` | `1` | `1` | `0` | `-0.595` | `2` |
| `seq_02_sql_to_error_handling` | `ARM_OFF` | `3.75` | `1` | `1` | `0` | `-0.65` | `0` |
| `seq_02_sql_to_error_handling` | `ARM_ON` | `3.625` | `1` | `1` | `0` | `-0.4715` | `2` |
...
- Secondary metrics: ['reflection_directive_present', 'stronger_directive_present', 'micro_coupling_applied', 'workspace_bias_present', 'tensions_trace_count', 'mood_min', 'mood_recovery_delta', 'loop_risk_proxy', 'retries_count']
...
- D2.2F is not D2.2 full and cannot support a general performance claim.

## Next Step

- If stronger directive still does not move decision-quality metrics, pause prompt tuning and improve semantic retry-plan instrumentation.
- If stronger directive moves decision-quality metrics without score/cert regression, consider a small D2.3 operational probe before D2.2 full.
